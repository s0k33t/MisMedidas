    ...
    Scaffold(
        ...
        floatingActionButton = {
            ...
            Row(modifier = Modifier.padding(16.dp)) {
                FloatingActionButton(onClick = {
                    ...
                    scope.launch {
                        // Espera a que el LazyColumn añada el item
                        kotlinx.coroutines.yield()

                        listState.animateScrollToItem(
                            index = viewModel.medidas.lastIndex +1,
                            scrollOffset = 0
                        )

                        viewModel.setUltimoMedidaUuid(nueva.uuid ?: "")
                    }
                }) {
        ...
        LazyColumn(
            ...
            items(viewModel.medidas) { medida ->
                ...
                MedidaItem(
                    medida = medida,
                    ultimoMedidaUuid = viewModel.ultimoMedidaUuid,
                    ajustesViewModel = ajustesViewModel,
                    tipos = tipos,
